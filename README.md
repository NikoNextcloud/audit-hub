...
След обновяването на календарите изпълни веднъж `supabase-calendar-categories.sql`. Той добавя споделените полета за категория и цвят, така че редакциите да се запазват за всички потребители.
